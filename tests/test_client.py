...
class TestWormAI:
    ...
    def test_chat_initialization(self, mock_session):
        ...
        mock_response.json.return_value = {"conversation_id": "test_conv_id"}
        mock_response.iter_lines.return_value = [b'data: {"text": "Hello"}', b"data: [DONE]"]
...
class TestWormAIIntegration:
    ...
    def test_chat_with_proxy(self):
        ...
        _ = WormAI(proxy="socks5://127.0.0.1:9050")
